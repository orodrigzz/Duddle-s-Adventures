...
public class Yellow_Projectile : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (hitInfo.collider != null)
        {
            ...
            if (hitInfo.collider.CompareTag("SlimoYellow"))
            {
            ...
            if (hitInfo.collider.CompareTag("PigeroYellow"))
            {
            ...
            if (hitInfo.collider.CompareTag("PigeroRed") || hitInfo.collider.CompareTag("PigeroGreen"))
            {
